...
const MOCK_MARKETS: Record<Exchange, Market[]> = {
  ...
  bydfi: [
    { symbol: "BTCUSDT", baseAsset: "BTC", quoteAsset: "USDT", pricePrecision: 1, quantityPrecision: 4 },
    ...
    { symbol: "XRPUSDT", baseAsset: "XRP", quoteAsset: "USDT", pricePrecision: 4, quantityPrecision: 0 },
    ...
    { symbol: "ARBUSDT", baseAsset: "ARB", quoteAsset: "USDT", pricePrecision: 4, quantityPrecision: 1 },
    { symbol: "OPUSDT", baseAsset: "OP", quoteAsset: "USDT", pricePrecision: 4, quantityPrecision: 1 },
    { symbol: "APTUSDT", baseAsset: "APT", quoteAsset: "USDT", pricePrecision: 3, quantityPrecision: 2 },
  ],
};
